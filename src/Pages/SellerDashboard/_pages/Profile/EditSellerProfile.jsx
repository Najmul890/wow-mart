    ...
    <>
      ...
      <div className="section-container flex py-10">
        ...
        <div className=" w-full pl-0 2md:pl-7 2md:w-[calc(100%-280px)] ">
          ...
          <form onSubmit={handleEditProfile} className="p-5 mt-10 shadow-lg rounded-lg bg-white ">
            <div className="mb-4 profile-user">
              ...
              <div className="file-upload">
                ...
                <label htmlFor="profile-img-file-input" className="file-label ">
                  <div className="ml-[-20px] mt-[30px]"><CameraIcon/></div>
                </label>
                <span className="file-info text-tertiary hidden">No file chosen</span>
              </div>
            </div>
            ...
            <div className="mt-5 mb-3">
              <button type="" className="btn btn-primary text-tertiary rounded-[30px] btn-sm capitalize font-semibold bg-primary hover:bg-primary border-primary ">
                Update
              </button>
            </div>
          </form>
